      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[var(--fg-muted)]">
              ...
              <li><Link href="https://twitter.com/zeroterm" className="hover:text-[var(--accent)] transition-colors">Twitter/X</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="pt-8 border-t border-[var(--border)] flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-[var(--fg-muted)]">
            © 2025 ZeroTerm Contributors. MIT Licensed. Built with Rust + wgpu.
          </p>
          <div className="flex items-center gap-6">
            ...
            <a href="https://twitter.com/zeroterm" className="text-[var(--fg-muted)] hover:text-[var(--accent)] transition-colors" aria-label="Twitter">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 9.24h-3.304l-7.12-8.289-7.16 8.289h-3.31l7.316-8.36-7.284-8.24h3.317l7.146 8.29 7.18-8.29h3.31z"/></svg>
            </a>
          </div>
        </div>
      </div>
